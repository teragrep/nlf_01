...
public final class AzureActivityType implements EventType {

    private final ParsedEvent parsedEvent;
    private final String realHostname;
    private final String componentNameForPartitions;

    public AzureActivityType(
    ...
    public String hostname() throws PluginException {
        ...
        final ValidKey<String> validKey = new ValidStringKey(record, "SubscriptionId");

        final String subscriptionId = validKey.value();

        return new ValidRFC5424Hostname("md5-".concat(new MD5Hash(subscriptionId).md5()))
    ...
    public String appName() throws PluginException {
        ...
        return new ValidRFC5424AppName(
                new ASCIIString(new ValidStringKey(record, "Type").value()).withNonAsciiCharsRemoved()
        ).appName();
    }
