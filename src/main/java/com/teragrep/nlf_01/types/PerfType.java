...
public final class PerfType implements EventType {

    private final ParsedEvent parsedEvent;
    private final String realHostname;
    private final String componentNameForPartitions;

    public PerfType(final ParsedEvent parsedEvent, final String realHostname, final String componentNameForPartitions) {
    ...
    public String appName() throws PluginException {
        ...
        return new ValidRFC5424AppName(new ValidStringKey(record, "Computer").value()).appName();
    }
