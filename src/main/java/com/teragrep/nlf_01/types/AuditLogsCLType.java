...
public final class AuditLogsCLType implements EventType {

    private final ParsedEvent parsedEvent;
    private final String realHostname;
    private final String componentNameForPartitions;

    public AuditLogsCLType(
    ...
    public String appName() throws PluginException {
        ...
        final ValidKey<String> validKey = new ValidStringKey(mainObject, "resourceName");
        return new ValidRFC5424AppName(validKey.value()).appName();
    }
