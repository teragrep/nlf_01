...
class WindowsEventTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/windows_event.json", new EventPartitionContextFake(), new EventPropertiesFake(),
                new EventSystemPropertiesFake(), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final WindowsEventType type = new WindowsEventType(parsedEvent, "localhost", "aer");
        ...
        Assertions.assertEquals("Windows", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"AzureDeploymentID\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Computer\":\"computer\",\"EventCategory\":1,\"EventData\":\"eventData\",\"EventID\":12345,\"EventLevel\":40,\"EventLevelName\":\"Error\",\"EventLog\":\"eventLog\",\"ManagementGroupName\":\"managementGroup\",\"Message\":\"message\",\"ParameterXml\":\"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n\",\"RenderedDescription\":\"rendererDescription\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"Role\":\"role\",\"Source\":\"Windows\",\"SourceSystem\":\"Windows\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"TimeGenerated\":\"2020-01-01T01:02:34.5678999Z\",\"Type\":\"Event\",\"UserName\":\"userName\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/windows_event.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/windows_event_missing_keys.json", new EventPartitionContextStub(),
        ...
        Assertions
                .assertEquals(
                        "{\"AzureDeploymentID\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Computer\":\"computer\",\"EventCategory\":1,\"EventData\":\"eventData\",\"EventID\":12345,\"EventLevel\":40,\"EventLevelName\":\"Error\",\"EventLog\":\"eventLog\",\"ManagementGroupName\":\"managementGroup\",\"Message\":\"message\",\"ParameterXml\":\"<?xml version=\\\"1.0\\\" encoding=\\\"UTF-8\\\"?>\\n\",\"RenderedDescription\":\"rendererDescription\",\"Role\":\"role\",\"SourceSystem\":\"Windows\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Type\":\"Event\",\"UserName\":\"userName\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
    ...
    void testSdElementReturnValue() {
        ...
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/windows_event.json", new EventPartitionContextImpl(partitionContextMap), new EventPropertiesImpl(propertiesMap), new EventSystemPropertiesImpl(systemPropertiesMap), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );
