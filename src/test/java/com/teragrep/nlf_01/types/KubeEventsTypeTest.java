...
final class KubeEventsTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/kubeevents.json", new EventPartitionContextFake(), new EventPropertiesFake(),
                new EventSystemPropertiesFake(), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final KubeEventsType type = new KubeEventsType(parsedEvent, "localhost", "aer");
        ...
        Assertions.assertEquals("cluster1", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"ClusterId\":\"cluster1234567\",\"ClusterName\":\"cluster1\",\"Computer\":\"computer1\",\"Count\":10,\"FirstSeen\":\"2020-01-01T00:23:34.5678999Z\",\"KubeEventType\":\"Normal\",\"LastSeen\":\"2020-01-01T01:23:34.5678999Z\",\"Message\":\"message1\",\"Name\":\"autoschedulejob-158393400-gkv4g\",\"Namespace\":\"kube-system\",\"ObjectKind\":\"pod\",\"Reason\":\"reason1\",\"SourceComponent\":\"default-scheduler\",\"SourceSystem\":\"Azure\",\"TimeGenerated\":\"2020-01-03T01:23:34.5678999Z\",\"Type\":\"KubeEvents\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\"}",
                        actualMsg
                );
        Assertions.assertEquals("12345678900", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
        Assertions.assertEquals(1578014614567L, actualTimestamp);
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/kubeevents.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/kubeevents_missing_keys.json", new EventPartitionContextStub(),
        ...
        Assertions
                .assertEquals(
                        "{\"ClusterId\":\"cluster1234567\",\"Computer\":\"computer1\",\"Count\":10,\"FirstSeen\":\"2020-01-01T00:23:34.5678999Z\",\"KubeEventType\":\"Normal\",\"LastSeen\":\"2020-01-01T01:23:34.5678999Z\",\"Message\":\"message1\",\"Name\":\"autoschedulejob-158393400-gkv4g\",\"Namespace\":\"kube-system\",\"ObjectKind\":\"pod\",\"Reason\":\"reason1\",\"SourceComponent\":\"default-scheduler\",\"SourceSystem\":\"Azure\",\"Type\":\"KubeEvents\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
