...
final class PerfTypeTest {
    ...
    void testIdealCase() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/perf.json", new EventPartitionContextFake(), new EventPropertiesFake(),
                new EventSystemPropertiesFake(), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final PerfType type = new PerfType(parsedEvent, "localhost", "aer");
        ...
        Assertions.assertEquals("computer1", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"BucketEndTime\":\"2021-01-01T01:23:34.5678999Z\",\"BucketStartTime\":\"2022-01-01T01:23:34.5678999Z\",\"Computer\":\"computer1\",\"CounterName\":\"counter1\",\"CounterPath\":\"\\\\computer1\\\\instance1\\\\counter1\",\"CounterValue\":1.1,\"InstanceName\":\"instance1\",\"Max\":1.2,\"Min\":1.0,\"ObjectName\":\"object1\",\"SampleCount\":1,\"SourceSystem\":\"Azure\",\"StandardDeviation\":2.0,\"TimeGenerated\":\"2020-01-01T01:23:34.5678999Z\",\"TenantId\":\"456\",\"Type\":\"Perf\",\"_ItemId\":\"123\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/perf.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/perf_missing_keys.json", new EventPartitionContextStub(), new EventPropertiesStub(),
                new EventSystemPropertiesStub(), new EnqueuedTimeStub(), new EventOffsetStub()
        );
        ...
        Assertions
                .assertEquals(
                        "{\"BucketEndTime\":\"2021-01-01T01:23:34.5678999Z\",\"BucketStartTime\":\"2022-01-01T01:23:34.5678999Z\",\"CounterName\":\"counter1\",\"CounterPath\":\"\\\\computer1\\\\instance1\\\\counter1\",\"CounterValue\":1.1,\"InstanceName\":\"instance1\",\"Max\":1.2,\"Min\":1.0,\"ObjectName\":\"object1\",\"SampleCount\":1,\"SourceSystem\":\"Azure\",\"StandardDeviation\":2.0,\"TenantId\":\"456\",\"Type\":\"Perf\",\"_ItemId\":\"123\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
