...
class DataverseActivityTypeTest {
    ...
    void testIdealCase() {
        ...
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/dataverseactivity.json", new EventPartitionContextImpl(partitionContextMap), new EventPropertiesImpl(propertiesMap), new EventSystemPropertiesImpl(systemPropertiesMap), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        Assertions.assertEquals("DataverseActivity", parsedEvent.asJsonStructure().asJsonObject().getString("Type"));

        final DataverseActivityType type = new DataverseActivityType(parsedEvent, "localhost", "aer");
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/dataverseactivity.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/dataverseactivity_missing_keys.json", new EventPartitionContextStub(),
        ...
        Assertions
                .assertEquals(
                        "{\"ClientIp\":\"127.0.0.1\",\"CorrelationId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"CrmOrganizationUniqueName\":\"Organization-1\",\"EntityId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"EntityName\":\"Entity-1\",\"Fields\":\"{}\",\"InstanceUrl\":\"https://{uri1}\",\"ItemType\":\"Message\",\"Message\":\"Message 1\",\"Operation\":\"Operation 1\",\"OrganizationId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"OriginalObjectId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Query\":\"Query\",\"QueryResults\":\"2\",\"ResultStatus\":\"Success\",\"ServiceContextId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"ServiceContextIdType\":\"Token 1\",\"ServiceName\":\"Service 1\",\"SourceRecordId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"SourceSystem\":\"Azure\",\"SystemUserId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"TenantId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Type\":\"DataverseActivity\",\"UserAgent\":\"Mozilla/5.0 (<system-information>) <platform> (<platform-details>) <extensions>\",\"UserId\":\"user@localhost.example.test\",\"UserKey\":\"UserKey-1\",\"UserType\":\"Admin\",\"UserUpn\":\"user@localhost.example.test\",\"Workload\":\"Service1\",\"_ItemId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_TimeReceived\":\"2025-10-06T00:00:00.0000000Z\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
