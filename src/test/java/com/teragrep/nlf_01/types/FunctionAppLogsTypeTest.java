...
class FunctionAppLogsTypeTest {
    ...
    void testIdealCase() {
        ...
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/function.json", new EventPartitionContextImpl(fakeTestMetadata.partitionContextMap()), new EventPropertiesImpl(fakeTestMetadata.propertiesMap()), new EventSystemPropertiesImpl(fakeTestMetadata.systemPropertiesMap()), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );
