...
class AppEventsTypeTest {
    ...
    void testIdealCase() {
        ...
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appevents.json", new EventPartitionContextImpl(partitionContextMap), new EventPropertiesImpl(propertiesMap), new EventSystemPropertiesImpl(systemPropertiesMap), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final AppEventsType type = new AppEventsType(parsedEvent, "localhost");
        ...
        Assertions.assertEquals("AppEvents", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"AppRoleInstance\":\"app-role-instance\",\"AppRoleName\":\"app-role-name\",\"ClientBrowser\":\"Browser\",\"ClientCity\":\"City\",\"ClientCountryOrRegion\":\"Country\",\"ClientIP\":\"192.168.1.2\",\"ClientModel\":\"CModel\",\"ClientOS\":\"OperatingSystem\",\"ClientStateOrProvince\":\"State\",\"ClientType\":\"client-type\",\"IKey\":\"i-key\",\"ItemCount\":1,\"Measurements\":\"{}\",\"Name\":\"Human Readable Name\",\"OperationId\":\"123\",\"ParentId\":\"456\",\"Properties\":{\"ProcessId\":\"1234\",\"HostInstanceId\":\"123456\",\"prop__{OriginalFormat}\":\"abc\",\"prop__RouteName\":\"xyz\",\"LogLevel\":\"Debug\",\"EventId\":\"1\",\"prop__RouteTemplate\":\"route/template\",\"Category\":\"192.168.3.1\",\"EventName\":\"event-name\"},\"ResourceGUID\":\"123456789\",\"SDKVersion\":\"12: 192.168.x.x\",\"SessionId\":\"12: 192.168.x.x\",\"SourceSystem\":\"Azure\",\"SyntheticSource\":\"Source\",\"TenantId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"TimeGenerated\":\"2020-01-01T01:02:34.5678999Z\",\"Type\":\"AppEvents\",\"UserAccountId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"UserAuthenticatedId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"UserId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_BilledSize\":1,\"_ItemId\":\"12-34-56-78\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appevents.json", new EventPartitionContextStub(), new EventPropertiesStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/appevents_missing_keys.json", new EventPartitionContextStub(),
        ...
        Assertions
                .assertEquals(
                        "{\"AppRoleInstance\":\"app-role-instance\",\"AppRoleName\":\"app-role-name\",\"ClientBrowser\":\"Browser\",\"ClientCity\":\"City\",\"ClientCountryOrRegion\":\"Country\",\"ClientIP\":\"192.168.1.2\",\"ClientModel\":\"CModel\",\"ClientOS\":\"OperatingSystem\",\"ClientStateOrProvince\":\"State\",\"ClientType\":\"client-type\",\"IKey\":\"i-key\",\"ItemCount\":1,\"Measurements\":\"{}\",\"Name\":\"Human Readable Name\",\"OperationId\":\"123\",\"ParentId\":\"456\",\"Properties\":{\"ProcessId\":\"1234\",\"HostInstanceId\":\"123456\",\"prop__{OriginalFormat}\":\"abc\",\"prop__RouteName\":\"xyz\",\"LogLevel\":\"Debug\",\"EventId\":\"1\",\"prop__RouteTemplate\":\"route/template\",\"Category\":\"192.168.3.1\",\"EventName\":\"event-name\"},\"ResourceGUID\":\"123456789\",\"SDKVersion\":\"12: 192.168.x.x\",\"SessionId\":\"12: 192.168.x.x\",\"SourceSystem\":\"Azure\",\"SyntheticSource\":\"Source\",\"TenantId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"UserAccountId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"UserAuthenticatedId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"UserId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_BilledSize\":1,\"_ItemId\":\"12-34-56-78\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
