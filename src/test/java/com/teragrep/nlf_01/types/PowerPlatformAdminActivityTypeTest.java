...
class PowerPlatformAdminActivityTypeTest {
    ...
    void testIdealCase() {
        ...
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/powerplatformadminactivity.json", new EventPartitionContextImpl(partitionContextMap), new EventPropertiesImpl(propertiesMap), new EventSystemPropertiesImpl(systemPropertiesMap), new EnqueuedTimeImpl("2010-01-01T00:00:00"), new EventOffsetImpl("0")
        );

        final PowerPlatformAdminActivityType type = new PowerPlatformAdminActivityType(parsedEvent, "localhost");
        ...
        Assertions.assertEquals("PowerPAA_Environment-01", actualAppName);
        ...
        Assertions
                .assertEquals(
                        "{\"ActorName\":\"localhost@localhost.example.test\",\"ActorUserId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"ActorUserType\":\"Admin\",\"EnvironmentId\":\"Environment-01\",\"EventOriginalType\":\"OriginalType\",\"EventOriginalUid\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"EventResult\":\"Succeeded\",\"OrganizationId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Properties\":\"{}\",\"PropertyCollection\":\"{}\",\"RecordType\":\"exchangeAdmin\",\"RequiresCustomerKeyEncryption\":true,\"SourceSystem\":\"Azure\",\"Type\":\"PowerAutomateActivity\",\"TenantId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"TimeGenerated\":\"2025-10-06T00:00:00.0000000Z\",\"Workload\":\"Service1\",\"_ItemId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_ResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_TimeReceived\":\"2025-10-06T00:00:00.0000000Z\",\"_Internal_WorkspaceResourceId\":\"/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/{resourceProviderNamespace}/{resourceType}/{resourceName}\"}",
                        actualMsg
                );
    ...
    void testWithAllMetadataStubs() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/powerplatformadminactivity.json", new EventPartitionContextStub(),
    ...
    void testWithMissingJsonKeys() {
        final ParsedEvent parsedEvent = testEvent(
                "src/test/resources/powerplatformadminactivity_missing_keys.json", new EventPartitionContextStub(),
                new EventPropertiesStub(), new EventSystemPropertiesStub(), new EnqueuedTimeStub(),
                new EventOffsetStub()
        );
        ...
        Assertions
                .assertEquals(
                        "{\"ActorName\":\"localhost@localhost.example.test\",\"ActorUserId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"ActorUserType\":\"Admin\",\"EventOriginalType\":\"OriginalType\",\"EventOriginalUid\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"EventResult\":\"Succeeded\",\"OrganizationId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Properties\":\"{}\",\"PropertyCollection\":\"{}\",\"RecordType\":\"exchangeAdmin\",\"RequiresCustomerKeyEncryption\":true,\"SourceSystem\":\"Azure\",\"Type\":\"PowerAutomateActivity\",\"TenantId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"Workload\":\"Service1\",\"_ItemId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_SubscriptionId\":\"bb41a487-309b-4d21-9ab8-2a8b948b2d18\",\"_TimeReceived\":\"2025-10-06T00:00:00.0000000Z\"}",
                        actualMsg
                );
        Assertions.assertEquals("", actualMsgId);
        Assertions.assertEquals(Severity.NOTICE, actualSeverity);
